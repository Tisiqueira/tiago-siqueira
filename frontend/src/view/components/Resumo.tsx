...
import { FaUser, FaChartBar, FaTasks, FaReact, FaNodeJs, FaHtml5, FaJs, FaGithub, FaMicrosoft } from 'react-icons/fa';
        ...
        <h4 >
          Com mais de{' '}
            ...
            <div className='flex mt-8 h-16 mr-0'>
              ...
              >
              <svg xmlns="http://www.w3.org/2000/svg"  style= {{transform: 'scale(0.7)',
                      height:'45',
                      width:'120',
                      margin:'0 0 0 0'
                    }}>
                  <g style= {{transform: 'scale(0.7)',
                    ...
                    <path className="st0" d="M22.9,31.6c3.1,1.2,4.1,4.1,4.3,5.8c0.1,0.9-0.6,1.4-0.6,1.4L11.1,49.6c-0.4-8,0.8-10.1,1.3-11.5  C14.9,31.9,19.9,30.4,22.9,31.6z" fill="#e5e7eb" >
                    </path>	
                    <path id="SVGID_12_" className="st1" d="M19.1,26c-8.3-5.4-8.3-10.2-7.9-18.9l30.3,21.2L29.1,37c0.2-3.8-2.6-5.8-4.1-7  c-0.9-0.7-2.1-1.4-3.1-2.2C20.4,26.9,19.1,26,19.1,26z" fill="#e5e7eb" >
                    </path>	
                    ...
                    <g style= {{transform: 'scale(0.8)',
                      ...
                      <path className="st2" d="M140,18.7c6.8,0,12.2,5.4,12.2,12.2s-5.5,12.2-12.3,12.2c-6.8,0-12.2-5.5-12.2-12.2    C127.7,24.1,133.1,18.7,140,18.7z M139.9,38.2c4.1,0,7.3-3.2,7.2-7.3c0-4.1-3.2-7.4-7.3-7.3c-4,0-7.1,3.2-7.2,7.3    C132.7,35.1,135.8,38.2,139.9,38.2z"fill="#e5e7eb"  >
                      </path>			
                      <path className="st2" d="M121,34.7c1.3,0.8,2.7,1.5,4.1,2.3c-1.5,3.9-6.9,6.7-11.6,6c-6.3-0.8-10.4-5.2-10.9-11.4    c-0.4-5.7,3.3-10.9,8.8-12.4c5.5-1.5,11.4,0.8,13.7,5.5c-1.4,0.8-2.7,1.6-4.2,2.5c-1.4-2.3-3.4-3.5-6-3.5c-2,0-3.8,0.6-5.2,2.1    c-2.8,2.8-2.8,7.8,0.1,10.6C113,39.3,117.4,38.7,121,34.7z"fill="#e5e7eb"  >
                      </path>			
                      <path className="st2" d="M55.7,42.6c0-10.8,0-17.6,0-28.3c1.8,0,3.5,0,5.3,0c0,9,0,14.1,0,23.3c4.4,0,7.8,0,12.2,0c0,1.8,0,3.4,0,5    C67.1,42.6,61.9,42.6,55.7,42.6z" fill="#e5e7eb"  >
                      </path>	
              ...
              <span>
                <svg width="111" height="40" viewBox="0 0 111 33" fill="none" xmlns="http://www.w3.org/2000/svg" >
                  ...
                  <linearGradient id="paint1_linear_8323_10753" x1="30.0088" y1="23.3589" x2="50.5328" y2="8.28841" gradientUnits="userSpaceOnUse">
                  ...
                  <linearGradient id="paint2_linear_8323_10753" x1="21.9168" y1="22.2608" x2="40.5549" y2="22.2608" gradientUnits="userSpaceOnUse">
