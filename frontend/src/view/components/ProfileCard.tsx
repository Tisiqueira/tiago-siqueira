export function ProfileCard(){
    return(
        ...
        >
            <div className="profile-wrapper w-[350px] h-[450px] relative border bg-orange-200">
                <div className="profile flex flex-col items-center  rounded-2xl  cursor-pointer transition-shadow">
                    <div className="absolute flex w-full h-full  bg-white-500 transition">
                    ...
                    <ul className="absolute flex gap-3 z-[3] top-full ">
                        <li>
                            <a href="#" title="">
